...
- 📄 **[Ver reporte final completo (Entregables 2, 3 y 4)](https://Rubi2120.github.io/RNAseq_Equipo4/Entregables_Completo.html)**
...
├── Entregables_Completo.html          # Reporte final renderizado
├── metadata.csv
└── README.md
```
