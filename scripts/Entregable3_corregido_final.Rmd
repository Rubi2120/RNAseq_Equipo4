...
```{r fig-counts, echo=FALSE, fig.cap="Figura 1. Conteo de secuencias por muestra (datos crudos).", out.width="90%"}
...
```{r fig-quality, echo=FALSE, fig.cap="Figura 2. Calidad de las secuencias por posición de base (datos crudos).", out.width="90%"}
knitr::include_graphics("../figures/fastqc_per_base_sequence_quality_plot.png")
```

```{r fig-quality-scores, echo=FALSE, fig.cap="Figura 3. Distribución de puntajes de calidad por secuencia (datos crudos).", out.width="90%"}
...
```{r fig-dup, echo=FALSE, fig.cap="Figura 4. Niveles de duplicación de secuencias (datos crudos).", out.width="90%"}
...
```{r fig-adapt, echo=FALSE, fig.cap="Figura 5. Contenido de adaptadores en los datos crudos.", out.width="90%"}
...
```{r fig-quality-post, echo=FALSE, fig.cap="Figura 6. Calidad post-trimming por posición de base.", out.width="90%"}
...
```{r diagrama, echo=FALSE, fig.cap="Figura 7. Diagrama de flujo del pipeline de análisis de RNA-seq. Se muestran los inputs (azul), procesos (amarillo/morado), outputs intermedios (gris) y la importación final en R (coral).", out.width="100%"}
knitr::include_graphics("../figures/pipeline_rnaseq.png")
```
...
tx2gene <- read.csv("../results_final/tx2gene_kallisto.csv")
